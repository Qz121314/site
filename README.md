...
一个基于 Astro SSR 与 Cloudflare 免费计划全家桶构建的多分区视觉推荐站。项目以图片浏览和转化为核心，通过中文管理后台维护分区、分类、产品、Hero 图片广告、转化池及 R2 图片资产。
...
公共站点采用图片优先的深色编辑风格；后台采用暖中性、高密度运营工作台风格。
...
- 数据迁移优先采用向后兼容的 expand/contract 方式
