...
test('production smoke validates storefront boot shell separately from admin root', async () => {
  ...
  assert.match(workflow, /assert_storefront_shell \/tmp\/storefront-root\.html/u);
  assert.match(
    workflow,
