...
test('site branding stays backend-driven and theme layouts stay structurally invariant', async () => {
  const [sharedUi, storefrontRoot, layout, storefrontMain, adminManifest] = await Promise.all([
