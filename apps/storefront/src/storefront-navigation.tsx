...
function builtinIcon(name: BottomNavigationBuiltinIcon | string | null): ReactNode {
  switch (name) {
    ...
    case 'heart':
      return navigationIcon(
        <path d="M20 8.7c0 5.3-8 10.1-8 10.1S4 14 4 8.7A4.4 4.4 0 0 1 12 6a4.4 4.4 0 0 1 8 2.7Z" />,
      );
    case 'user':
      return navigationIcon(
        <>
          <circle cx="12" cy="8" r="3.4" />
          <path d="M5.7 20c.8-3.7 3-5.6 6.3-5.6s5.5 1.9 6.3 5.6" />
        </>,
      );
    case 'menu':
    ...
    case 'bell':
      return navigationIcon(
        <>
          <path d="M6.7 16.5h10.6l-1.2-2V10a4.1 4.1 0 0 0-8.2 0v4.5l-1.2 2Z" />
